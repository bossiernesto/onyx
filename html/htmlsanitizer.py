...
#took from http://code.activestate.com/recipes/578008-safe-html-string-and-unicode/. Thanks Alex Garel for this snipplet.


def sanitize_html(value):   # function to sanitize html if needed from input
    return SafeHTMLStr(value)
...
class SafeHTMLUnicode(SafeHTMLMixin, str):
    ...
    SafeHTMLUnicode itself is not quoted::
      ...
      SafeHTMLUnicode('<ABC/><script src="x"/>')
    ...
    While any string or unicode input is quoted and keep being SafeHTML::
      ...
      SafeHTMLUnicode('&lt;script src=&quot;x&quot;&#x2F;&gt;<ABC/>')

      >>> SafeHTMLUnicode(u'<ABC/>') * 2
      SafeHTMLUnicode('<ABC/><ABC/>')

      >>> SafeHTMLUnicode(u'<ABC>%s</ABC>') % '<script src="x"/>'
      SafeHTMLUnicode('<ABC>&lt;script src=&quot;x&quot;&#x2F;&gt;</ABC>')

      >>> SafeHTMLUnicode(u'<ABC %s>%s</ABC>') % (
      ...      SafeHTMLUnicode(u'spam="foo"'), '<script src="x"/>')
      SafeHTMLUnicode('<ABC spam="foo">&lt;script src=&quot;x&quot;&#x2F;&gt;</ABC>')
    """
